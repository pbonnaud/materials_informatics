...
# coding: utf-8
###     
### Last modification (DD/MM/YYY) : 10/08/2023
###
####################################################################################################
###                                                                                              ###
### Physics-Informed Neural Networks (PINNs): Wave equation                                      ###
###                                                                                              ###
####################################################################################################
...
### Set the length and the total time ##############################################################
...
### Set the class that define the neural network (PINNs) ###########################################
                                                                                         # 
class PINN(nn.Module):                                                                   #
                                                                                         #
    # Simple neural network accepting two features as input and returning a single     ***
    # output                                                                           ***
    #                                                                                  ***
    ...
    #                                                                                  ***
    # It is problem independent - but, must be able to capture the complexities of the ***
    # problem at hand ...                                                              ***
                                                                                         #
    # Function that defines the initialization of the class ////////////////////////////////////////
                                                                                         #
    def __init__(self,                                                                   #
                 num_hidden: int, 
                 dim_hidden: int, 
    ...
    def forward(self, x, t):
        ...
        # if requested pin the boundary conditions using a surrogate model:           ***
        # (x - 0) * (x - L) * NN(x)                                                   ***
...
# #### Recall our PDE, the wave equation (note: 1D only here!)
# ![image-2.png](attachment:image-2.png)

# In[3]:

# Function that computes the full loss function of the PINN model //////////////////////////////////

def compute_loss(nn_approximator: PINN, 
                 x: torch.Tensor = None, 
                 t: torch.Tensor = None
                ) -> torch.float:
...
# Function that defines the model for the training /////////////////////////////////////////////////

def train_model(nn_approximator: PINN,
                loss_fn: Callable,
...
# Function that plots the solution /////////////////////////////////////////////////////////////////
...
def plot_solution(nn_trained: PINN, x: torch.Tensor, t: torch.Tensor):
    ...
    # Function that defines the animation of the result ////////////////////////////////////////////
...
#nn_approximator_trained = train_model(nn_approximator, 
#                                      loss_fn=loss_fn, 
#                                      learning_rate=0.005, 
#                                      max_epochs=20_000
#                                     );
...
### Plot the solution of the program ###############################################################
